...
input_params = {
    ...
    "apply_household_income_filter": {"min": 0.1, "max": 0.9},
...
if run_validation:
    ...
    plot_intermediate(
        input_params, "ruf_validation", tawa_data_name="sq", output_dir=output_dir
    )

if run_sensitivity:
    run_ruf_sensitivity(input_params, tawa_data_name="sq", output_dir=output_dir)
    plot_intermediate(
        input_params, "ruf_sensitivity", tawa_data_name="sq", output_dir=output_dir
    )
